...
QBI presents "Science in the Time of Corona", a live show where scientists discuss how COVID-19 has changed science. [On August 20th at noon](https://www.eventbrite.com/e/has-covid-19-changed-how-women-and-mothers-do-research-tickets-115255436112) join QBI for a discussion with two researchers in the QCRG about the unique impacts that COVID-19 has had on women and mothers in science. Event Description: Some have suggested that working from home presents a setback for women in science, but are there also lessons we can learn or positive changes to carry into the future? In this discussion we will hear from two women in science about their experiences doing research from home during quarantine, and talk about future implications of remote conferences and working from home for women and mothers in science. Panelists: Danica Fujimori - Professor, Cellular Molecular Pharmacology - QBI and UCSF, Ruth Huttenhain - Assistant Professor, Cellular Molecular Pharmacology - QBI and UCSF; Host: Leila Shokat - Media Anthropology - QBI
